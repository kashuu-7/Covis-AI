          ...
          <div className="relative flex justify-start animate-[fadeIn_0.3s_ease-out]">
            ...
            >
              <div className="relative text-sm leading-relaxed font-medium">
                <p className="my-1">{welcomeMessage}</p>
              </div>
            ...
            >
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between gap-3">
                  ...
                  {/* Copy + Speaker - SIRF BOT RESPONSE */}
                  {msg.role === "assistant" && (
                    <div className="flex items-center gap-1">
                      <button
                        type="button"
                        onClick={() => copyMessage(msg.text)}
                        className="inline-flex items-center justify-center rounded-md p-1 text-gray-500 transition-all duration-200 hover:bg-white/10 hover:text-white"
                      >
                        <Copy className="h-3.5 w-3.5" />
                      </button>
            ...
            <div className="relative animate-[fadeIn_0.3s_ease-out]">
              ...
              <div className="grid grid-cols-1 gap-2 min-[400px]:grid-cols-2">
                <button
                  type="button"
                  onClick={() =>
                    handleQuickMessage("How do I sign up for Covis AI?")
                  }
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleQuickMessage("How does the Covis AI platform work?")
                  }
                  className={`group flex cursor-pointer items-start gap-2.5 rounded-2xl border-2 px-3.5 py-3 text-left backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(133,0,219,0.35)]
                ...
                <button
                  onClick={() =>
                    handleQuickMessage("What features does Covis AI offer?")
                  }
                  type="button"
                  className={`group flex cursor-pointer items-start gap-2.5 rounded-2xl border-2 px-3.5 py-3 text-left backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(133,0,219,0.35)]
                ...
                >
                  ...
                  <span className="min-w-0">
                    <span className="block text-xs font-bold">Features</span>
        ...
        >
          ...
          >
            ...
            <button
              ...
              title={
                message.trim() ? "Send message" : "Please type a message first"
              }
